...
output "resource_postgresql_flexible_server_pass" {
    value = azurerm_postgresql_flexible_server.postgres-server--staging--.administrator_password
    sensitive = true
}
...
output "resource_postgresql_flexible_server_user" {
    value = azurerm_postgresql_flexible_server.postgres-server--staging--.administrator_login
    sensitive = true
}
